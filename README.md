...
* Во вкладке "База изображений" можно искать и фильтровать картинки по названию, описанию, дате, модели фотоаппарата и фокусному расстоянию.
	* По нажатию на изображение можно получить более подробную информацию о мета-данных, а также изменить их, однако изменения вносятся лишь в базу, не модифицируя самих файлов.
